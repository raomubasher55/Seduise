...
var storySchema = new Schema2({
  ...
  // Cost in credits to generate this story
}, { timestamps: true });
...
${existingContent.substring(0, 2e3)}...
...
router5.post("/create-checkout-session", authMiddleware, async (req, res) => {
  try {
    ...
    const planPrice = SUBSCRIPTION_PLANS3[plan].price;
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              name: `${SUBSCRIPTION_PLANS3[plan].name} Subscription`,
              description: SUBSCRIPTION_PLANS3[plan].description
            },
